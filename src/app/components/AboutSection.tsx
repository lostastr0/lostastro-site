      ...
      <div className="relative z-10 mx-auto max-w-6xl w-full">
          ...
          <div className="bg-gradient-to-br from-gray-900/70 to-black/70 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-blue-600/20 hover:border-blue-500/30 transition-all duration-500 shadow-2xl">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-blue-200/80 text-lg leading-relaxed">
                Every algorithm I learn, every system I build, is guided by one vision: 
                <em className="text-blue-400 font-medium"> "How can I create technology that makes life better?"</em>
              </p>
            </div>
          </div>
        </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-blue-100/80 leading-relaxed">
                  My journey starts with a <span className="text-purple-400 font-medium">Cert IV in Cybersecurity (Oct 2025 - Oct 2026)</span> 
                ...
                <p className="text-blue-100/80 leading-relaxed">
                  ...
                  Whether it's cybersecurity, AI, web development, or systems programming—
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-white mb-4">My Learning Path</h3>
